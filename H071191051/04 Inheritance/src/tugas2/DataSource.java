        ...
        while (true) {
            ...
            if (key == 0) {
                ...
                if (pi.equals("")) {
                    ...
                    System.out.print("+++++++ PENGURUS INTI +++++++");
                ...
                if (ks.equals("")) {
                    ...
                    System.out.print("+++++++ KORDINATOR BIDANG & STAF +++++++");
                ...
                if (positionList.get(position) != null) {
                    if (position > 0 && position < 5) {
                        ...
                        if (pengurus.getFaculty() == null) {
                            System.out.println("NIM tidak ada dalam daftar");
                        } else if (pengurus.getAge() == null) {
                            System.out.println("Format tanggal lahir tidak sesuai (gunakan format dd-MM-yyyy)");
                        } else {
                        ...
                        if (kordinator.getFaculty() == null) {
                            System.out.println("NIM tidak ada dalam daftar");
                        } else if (kordinator.getAge() == null) {
                            System.out.println("Format tanggal lahir tidak sesuai (gunakan format dd-MM-yyyy)");
                        } else {
                            System.out.println("Pendaftaran Berhasil");
